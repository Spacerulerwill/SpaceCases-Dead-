...
class Trading(commands.Cog):
    ...
    @commands.group(invoke_without_command=True, description="Show your trade currently in creation", usage=
    {
        "Syntax": f"`{PREFIX}trade`"
    })
    async def trade(self, ctx:Context):
        if ctx.invoked_subcommand is None:
            await view_trade_in_creation(ctx)

    @trade.command(description="Create a new trade with a user", usage=
    {
    ...
    @trade.command(description="Cancel your current trade in creation or a trade already sent to a user", usage=
    {
    ...
    @trade.command(description="Send your trade in creation to the recipient", usage=
    {
    ...
    @trade.command(description="Add an item to your trade in creation", usage=
    {
    ...
    @trade.command(description="Remove an item from your trade in creation", usage=
    {
    ...
    @trade.command(description="View an outgoing trade request", usage=
    {
    ...
    @trade.command(description="Accept a trade request from a user", usage={
    ...
    @trade.command(description="Decline a trade request", usage={
